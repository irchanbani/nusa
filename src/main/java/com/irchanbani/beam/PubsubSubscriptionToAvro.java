 ...
 * https://github.com/GoogleCloudPlatform/DataflowTemplates/blob/master/src/main/java/com/google/cloud/teleport/templates/PubsubToAvro.java
 * We modified the code to use read Pubsub from Subscriptions
 */
package com.irchanbani.beam;

import com.irchanbani.beam.avro.AvroPubsubMessageRecord;
import com.irchanbani.beam.io.WindowedFilenamePolicy;
import com.irchanbani.beam.util.DurationUtils;
 ...
 * </pre>
 */
public class PubsubSubscriptionToAvro {
  ...
  public interface Options extends PipelineOptions, StreamingOptions {
    ...
    @Description("The Cloud Pub/Sub ID Attribute to read from.")
    @Required
    @Default.String("uuid")
    ValueProvider<String> getInputAttributeId();

    void setInputAttributeId(ValueProvider<String> value);

    @Description("The Cloud Pub/Sub Timestamp Attribute to read from.")
    @Required
    @Default.String("timestamp")
    ValueProvider<String> getInputAttributeTimestamp();

    void setInputAttributeTimestamp(ValueProvider<String> value);
    ...
    pipeline
        .apply(
            ...
            PubsubIO.readMessagesWithAttributes().fromSubscription(options.getInputSubscription())
                    .withIdAttribute(options.getInputAttributeId().toString())
                    .withTimestampAttribute(options.getInputAttributeTimestamp().toString()))
